# 05 — Rattacher une adresse conserve tout ce que le compte portait
...
Le jour où elle sert — pour ne pas perdre ses réglages en changeant d'appareil,
ou parce qu'il y a de l'argent en jeu —, une adresse se rattache au compte
anonyme. **Rien ne se perd** : c'est le même compte, qui gagne un nom.

Et se connecter depuis un autre appareil avec cette adresse y ramène les
réglages, les profils et les trajets.

## Ce à quoi il faut faire attention

- **Rattacher n'est pas créer.** Créer un second compte et y recopier les données
...
- **Hors réseau, on ne se connecte pas.** C'est acceptable — on ne rattache pas
  une adresse en roulant —, mais l'écran doit le dire au lieu d'attendre.
- **Ce qui voyage et ce qui ne voyage pas.** Le volume, le visage de l'écran, le
  verrou, le mode de boîte décrivent l'appareil et restent locaux ; c'est déjà
  la règle du lot MIGRER, et elle ne change pas ici.
