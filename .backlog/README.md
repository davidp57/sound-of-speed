...
| [MOUVEMENT](MOUVEMENT/spec.md) — une seule notion de « est-ce qu'on ralentit ? » : cinq lectures de l'accélération cohabitent dans la boîte, avec cinq seuils qui ne s'accordent pas | 🔄 1/4 — le banc juge la boîte sur un vrai signal de récepteur : plus d'aller-retour, mais la marge n'est que d'un quart de bruit, et le bruit réel de la voiture n'est pas relevé |
