...
| [DURCIR](DURCIR/spec.md) — sécuriser le code et les données : fermer le service des échantillons, borner ce qu'un compte dépense, et prouver ce qu'un compte peut atteindre de ce qu'un autre a déposé | 🔄 11/17 ✅ + 3 🧑 — les échantillons demandent un compte, une banque peut être réservée, l'isolation est prouvée route par route, un nom déposé ne compose plus de chemin, le serveur sert une politique de contenu, et son relevé de dépense se lit enfin — écrit en base et affiché dans la régie, là où le journal du conteneur partait avec le conteneur ; le chiffrement au repos et les identifiants opaques sont tranchés. Reste la place à faire quand le plafond est atteint : instruite et découpée le 15 septembre en trois tickets (07 à 09) |
