...
| [SERVEUR](SERVEUR/spec.md) — 2/5 · un seul service TypeScript à la place de nginx et du profileur, avec une base et des migrations, à compte unique | 🧑 8/8 — tout est livré ; restent la pile à coller et la mesure sur le NAS |
