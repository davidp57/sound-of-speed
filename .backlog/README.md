...
| [ESSAI-16](ESSAI-16/spec.md) — dix points de la sortie du 16 septembre : un rétrogradage forcé qui ne partait jamais, des bandeaux qui recouvrent les commandes, un suivi GPS qui se relance sans cesse | 🔄 4/14 — le son ne repart plus au repos, mesuré au volume coupé, et le compte-tours frémit comme un vrai ; dix restent, dont les parasites des deux V8 et l'accéléromètre muet |
