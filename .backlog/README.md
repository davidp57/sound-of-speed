...
| [ESSAI-16](ESSAI-16/spec.md) — dix points de la sortie du 16 septembre : un rétrogradage forcé qui ne partait jamais, des bandeaux qui recouvrent les commandes, un suivi GPS qui se relance sans cesse | 🔄 5/14 — le son ne repart plus au repos, le compte-tours frémit comme un vrai, et le tremblement du ralenti a retrouvé sa moitié manquante ; neuf restent, dont l'accéléromètre muet. Les parasites des V8 sont mesurés et une banque adoucie attend son verdict |
