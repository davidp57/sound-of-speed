...
| [COMPTES](COMPTES/spec.md) — 5/5 · un compte anonyme d'abord, une adresse quand elle sert, et des droits qui ouvrent les écrans | 🔄 8/12 — le compte se tient : changer, emporter, supprimer ; restent le compte tiers, « j'ai oublié » (attend un relais), et les droits |
