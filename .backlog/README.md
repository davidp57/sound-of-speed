...
| [COMPTES](COMPTES/spec.md) — 5/5 · un compte anonyme d'abord, une adresse quand elle sert, et des droits qui ouvrent les écrans | 🔄 9/13 — les rôles ouvrent les écrans et le serveur refuse le reste ; restent l'axe appareil, le compte tiers et « j'ai oublié » (attend un relais) |
