...
| [ESSAI-16](ESSAI-16/spec.md) — dix points de la sortie du 16 septembre : un rétrogradage forcé qui ne partait jamais, des bandeaux qui recouvrent les commandes, un suivi GPS qui se relance sans cesse | 🔄 2/14 — le rétrogradage forcé est corrigé et le curseur mort retiré ; douze restent, dont les parasites des deux V8, le son qui repart au repos et l'accéléromètre muet |
