...
| [SUITE-ESSAI-11](SUITE-ESSAI-11/spec.md) — deux points de l'essai du 11 septembre : un dépôt qui repartait en boucle à l'arrêt, et une relance GPS de secours | 🧑 2/2 — ce n'étaient pas 726 dépôts manqués mais une tranche réessayée 726 fois, faute de recul après échec ; corrigé et mesuré, reste l'essai en roulant |
