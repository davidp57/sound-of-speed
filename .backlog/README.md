...
| [RELECTURE](RELECTURE/spec.md) — revoir un trajet au bureau au lieu de le raconter de mémoire : une seule capture, automatique, et un relecteur avec timeline et carte | 🔄 42 critères sur 46 établis le 12 septembre ; trois finitions et l'écoute du rejeu restent |
