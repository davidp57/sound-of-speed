...
| [COMPTES](COMPTES/spec.md) — 5/5 · un compte anonyme d'abord, une adresse quand elle sert, et des droits qui ouvrent les écrans | 🔄 14/15 — le parcours d'appropriation est celui des autres applications, les deux axes ouvrent les écrans, et un fournisseur se connecte quand il est configuré ; Google est configuré sur le NAS et vérifié là-bas ; restent un essai hors réseau en voiture et « j'ai oublié » (attend un relais) |
