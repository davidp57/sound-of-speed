...
| [COMPTES](COMPTES/spec.md) — 5/5 · un compte anonyme d'abord, une adresse quand elle sert, et des droits qui ouvrent les écrans | 🔄 5/12 — un jeton de liaison, deux rendus : un code à scanner et huit caractères à taper ; reste l'écran dédié aux comptes |
