...
| [COMPTES](COMPTES/spec.md) — 5/5 · un compte anonyme d'abord, une adresse quand elle sert, et des droits qui ouvrent les écrans | 🔄 18/20 — le parcours d'appropriation est celui des autres applications, les deux axes ouvrent les écrans, et un fournisseur se connecte quand il est configuré ; Google est configuré sur le NAS, vérifié là-bas, et un compte qui s'y rattache annonce enfin son adresse ; l'écran du compte met en tête les deux gestes qu'on vient y faire ; restent un essai hors réseau en voiture, « j'ai oublié » (attend un relais) et l'effacement d'un compte vide |
