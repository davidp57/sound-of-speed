...
| [ESSAI-16](ESSAI-16/spec.md) — six points de la sortie du 16 septembre : un rétrogradage forcé qui ne partait jamais, des bandeaux qui recouvrent les commandes, un suivi GPS qui se relance sans cesse | 🔄 2/7 — le rétrogradage forcé est corrigé, mesuré sur 58 000 relevés, et le curseur de seuil qui ne commandait plus rien est retiré ; les cinq autres sont à instruire |
