...
| [COMPTES](COMPTES/spec.md) — 5/5 · un compte anonyme d'abord, une adresse quand elle sert, et des droits qui ouvrent les écrans | 🔄 8/13 — le compte se tient : changer, emporter, supprimer ; restent les deux axes qui ouvrent les écrans (rôle et appareil), le compte tiers et « j'ai oublié » (attend un relais) |
