...
| [DURCIR](DURCIR/spec.md) — sécuriser le code et les données : fermer le service des échantillons, borner ce qu'un compte dépense, et prouver ce qu'un compte peut atteindre de ce qu'un autre a déposé | 🧑 17/17 — **tout est livré**, y compris la place à faire quand le plafond est atteint : le serveur annonce la place sur chaque dépôt, la rotation efface le plus ancien non épinglé, et l'application prévient aux trois quarts. Restent deux vérifications qui ne se font pas depuis un poste : le cache hors réseau en voiture, et lire le relevé de dépense après quelques jours |
