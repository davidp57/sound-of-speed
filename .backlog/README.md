...
| [SERVEUR](SERVEUR/spec.md) — 2/5 · un seul service TypeScript à la place de nginx et du profileur, avec une base et des migrations, à compte unique | 🔄 2/8 — le contrat est figé, les frontières tiennent |
