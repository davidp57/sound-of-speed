...
| [REMONTEE](REMONTEE/spec.md) — tout ce qui naît dans la voiture remonte tout seul : traces, journal, relevés de mesure, profils, sur un accord unique | 🧑 — le sens montant est prouvé ; le **retour** du serveur duplique au lieu de mettre à jour, relevé le 17 septembre ([ticket 08](REMONTEE/tickets/08-reprendre-du-serveur-sans-dupliquer.md)) |
