...
| [DURCIR](DURCIR/spec.md) — sécuriser le code et les données : fermer le service des échantillons, borner ce qu'un compte dépense, et prouver ce qu'un compte peut atteindre de ce qu'un autre a déposé | ⬜ 0/14 — instruit et découpé le 15 septembre ; les rôles bornent une dépense, d'où l'ordre mesurer / fermer / borner |
